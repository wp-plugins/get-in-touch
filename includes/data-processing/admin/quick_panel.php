	...
	<div id="input-fields-options">		
		...
		<div id="map-container" style="display: none;">			
    	    <form class="form-horizontal" name="content_form_map" id="content_form_map" action="#" method="post">
	            ...
	            <div class="git-fields-container" id="color-container">	
	                <label for="name">Color:</label>
	                <div class="git-controls">
		        	    <input type="hidden" value="#89b6ff" id="git_map_color" name="git_map_color" for="color" value="" placeholder="Select Color">
	        	    </div>
	            </div>
	            <div class="git-fields-container">	
	                <label for="name">Height: (Pixel)</label>
	                <div class="git-controls">
		        	    <input type="text" id="git_map_height" name="git_map_height" for="height" value="" placeholder="Enter Height for Map">
	        	    </div>
	            </div>
	            <div class="git-fields-container">	
	                <label for="name">Width: (Pixel)</label>
	                <div class="git-controls">
	            ...
	            <!-- <div class="git-fields-container">	
	                ...
	                <div class="git-controls">
		        	    <input type="text" id="git_map_zoom" name="git_map_zoom" for="zoom" value="12" placeholder="Enter Zoom Level for Map">
	        	    </div>
	            </div>
	            <div class="git-fields-container">	
	                <label for="name">Clickable:</label>
	                <div class="git-controls">
		        	    <input type="checkbox" id="git_map_clickable" name="git_map_clickable">
	        	    </div>
	            </div>
	            <div class="git-fields-container">	
	                <label for="name">Draggable:</label>
	                <div class="git-controls">
		        	    <input type="checkbox" id="git_map_draggable" name="git_map_draggable">
	        	    </div>
	            </div>
	            <div class="git-fields-container">	
	                <label for="name">Scrollwheel:</label>
	                <div class="git-controls">
		        	    <input type="checkbox" id="git_map_scrollwheel" name="git_map_scrollwheel">
	        	    </div>
	            </div> -->
	           <div class="control-group btn-style">	              
	                <div class="git-controls">
		...
		<div id="captcha-container" style="display: none;">			
    	    <form name="content_form_captcha" id="content_form_captcha" action="#" method="post">		            
	            <div class="git-fields-container">	
	                <label for="name">Title:</label>
	                <div class="git-controls">
